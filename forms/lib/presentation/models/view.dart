...
class FormsModelView<T> extends StatelessWidget {
  final FormsModelStore<T> mapEditorStore;
  final Widget? header;
  final Map<String, Pair<BaseFormFieldStore<T>, Widget>> modelFields;
                ...
                builder: (context) {
                  return ListView.builder(
                    itemBuilder: (context, index) {
                      ...
                      final widget = modelFields[key]!.second;
                      return widget;
                    },
                  ...
                  //   child: _buildFormsModel(context, mapEditorStore.mapData, []),
                  // );
                },
              ),
            ),
  ...
  // Widget _buildFormsModel(BuildContext context, Map<dynamic, dynamic> map, List<String> keys) {
  //   return Padding(
  //     padding: const EdgeInsets.all(8),
  //     child: Column(
  ...
  //     children: [
  //       Padding(padding: const EdgeInsets.only(left: 16), child: _buildFormsModel(context, map, keys)),
  //     ],
  //   );
  // }
