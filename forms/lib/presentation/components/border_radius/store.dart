...
abstract class _BorderRadiusFormFieldStore
  ...
  void onTypeChanged(BorderRadiusType newType) {
    type = newType;
    value = (value ?? const BorderRadiusModel())
        .copyWith(type_enum_borderRadiusType: newType);
  }

  void onAllChanged(String allValue) {
    value = (value ?? const BorderRadiusModel())
        .copyWith(all_double: double.tryParse(allValue));
  }

  void onTopLeftChanged(String topLeftValue) {
    value = (value ?? const BorderRadiusModel())
        .copyWith(topLeft_double: double.tryParse(topLeftValue));
  }

  void onTopRightChanged(String topRightValue) {
    value = (value ?? const BorderRadiusModel())
        .copyWith(topRight_double: double.tryParse(topRightValue));
  }

  void onBottomLeftChanged(String bottomLeftValue) {
    value = (value ?? const BorderRadiusModel())
        .copyWith(bottomLeft_double: double.tryParse(bottomLeftValue));
  }

  void onBottomRightChanged(String bottomRightValue) {
    value = (value ?? const BorderRadiusModel())
        .copyWith(bottomRight_double: double.tryParse(bottomRightValue));
  }
}
