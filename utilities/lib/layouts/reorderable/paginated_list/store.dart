...
class ReorderablePaginatedListStore<T extends Object, K extends Comparable<K>> = _ReorderablePaginatedListStore<T, K> with _$ReorderablePaginatedListStore<T, K>;

/// [_ReorderablePaginatedListStore] is a class that manages the state of the ReorderableList feature.
abstract class _ReorderablePaginatedListStore<T extends Object, K extends Comparable<K>> extends PaginatedListStore<T, K> with Store {
