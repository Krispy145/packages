...
class ReorderableListBuilder<T extends Object, K extends Comparable<K>> extends StatelessWidget {
  final ReorderableListStore<T, K> store;
  final Widget? header;
  ...
  /// [ReorderableListBuilder] constructor.
  const ReorderableListBuilder.listView({
    super.key,
    required this.store,
    this.header,
  ...
  /// [ReorderableListBuilder] constructor.
  const ReorderableListBuilder.gridView({
    super.key,
    required this.store,
    this.header,
    required this.itemBuilder,
