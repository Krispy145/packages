...
class ReorderableStreamedListStore<T extends Object, K extends Comparable<K>> = _ReorderableStreamedListStore<T, K> with _$ReorderableStreamedListStore<T, K>;

/// [_ReorderableStreamedListStore] is a class that manages the state of the ReorderableList feature.
abstract class _ReorderableStreamedListStore<T extends Object, K extends Comparable<K>> extends StreamedListStore<T, K> with Store {
