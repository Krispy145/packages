...
class ReorderableListStore<T extends Object, K extends Comparable<K>> = _ReorderableListStore<T, K> with _$ReorderableListStore<T, K>;

/// [_ReorderableListStore] is a class that manages the state of the ReorderableList feature.
abstract class _ReorderableListStore<T extends Object, K extends Comparable<K>> extends ListStore<T, K> with Store {
