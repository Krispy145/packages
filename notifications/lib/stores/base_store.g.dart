...
mixin _$NotificationsStore on _NotificationsStore, Store {
  ...
  late final _$searchAllAsyncAction = AsyncAction('_NotificationsStore.searchAll', context: context);

  @override
  Future<List<NotificationModel?>> searchAll(Map<String, dynamic> query) {
    return _$searchAllAsyncAction.run(() => super.searchAll(query));
  }

  late final _$searchAsyncAction = AsyncAction('_NotificationsStore.search', context: context);

  @override
  Future<NotificationModel?> search(Map<String, dynamic> query) {
