...
class VideoPlayerFactory: NSObject, FlutterPlatformViewFactory {
    ...
    static func register(with registrar: FlutterPluginRegistrar) {
        ...
        registrar.register(plugin, withId: "com.digitaloasis/NativeVideoPlayer")
    }
...
class VideoPlayer: NSObject, FlutterPlugin, FlutterStreamHandler, FlutterPlatformView {
    ...
    deinit {
        print("[dealloc] com.digitaloasis/NativeVideoPlayer")
    }
    ...
    private func setupEventChannel(viewId: Int64, messenger:FlutterBinaryMessenger, instance:VideoPlayer) {
        ...
        instance.eventChannel = FlutterEventChannel(name: "com.digitaloasis/NativeVideoPlayerEventChannel_" + String(viewId), binaryMessenger: messenger, codec: FlutterJSONMethodCodec.sharedInstance())
    ...
    private func setupMethodChannel(viewId: Int64, messenger:FlutterBinaryMessenger) {
        ...
        let nativeMethodsChannel = FlutterMethodChannel(name: "com.digitaloasis/NativeVideoPlayerMethodChannel_" + String(viewId), binaryMessenger: messenger);
