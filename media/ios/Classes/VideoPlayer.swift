...
class VideoPlayerFactory: NSObject, FlutterPlatformViewFactory {
    ...
    static func register(with registrar: FlutterPluginRegistrar) {
        ...
        registrar.register(plugin, withId: "ae.digitaloasis/NativeVideoPlayer")
    }
...
class VideoPlayer: NSObject, FlutterPlugin, FlutterStreamHandler, FlutterPlatformView {
    ...
    private func setupEventChannel(viewId: Int64, messenger:FlutterBinaryMessenger, instance:VideoPlayer) {
        ...
        instance.eventChannel = FlutterEventChannel(name: "ae.digitaloasis/NativeVideoPlayerEventChannel_" + String(viewId), binaryMessenger: messenger, codec: FlutterJSONMethodCodec.sharedInstance())
    ...
    private func setupMethodChannel(viewId: Int64, messenger:FlutterBinaryMessenger) {
        ...
        let nativeMethodsChannel = FlutterMethodChannel(name: "ae.digitaloasis/NativeVideoPlayerMethodChannel_" + String(viewId), binaryMessenger: messenger);
