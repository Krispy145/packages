...
sealed class PlaylistDataSource<Resp extends ResponseModel>
    with
        DataSource<PlaylistModel, BasicSearchQueryModel>,
        Paginated<Resp, PlaylistModel, BasicSearchQueryModel> {}
