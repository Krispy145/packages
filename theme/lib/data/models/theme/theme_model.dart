...
class ComponentThemesModel with ComponentThemesModelMappable {
  ...
  const ComponentThemesModel({
    ...
    this.floatingActionButtons = const {
      primaryStyle: FloatingActionButtonModel(),
    },
  ...
  T? getComponentThemeFromStyleType<T>(String styleType) {
    if (isSameType<T, ThemeData>()) {
      ...
      return tabBars?[styleType]?.asTabBarThemeData(styleTypeName: styleType)
          as T;
      ...
      return dialogs?[styleType]?.asDialogThemeData(styleTypeName: styleType)
          as T;
