...
_$TextStyleModelImpl _$$TextStyleModelImplFromJson(Map<String, dynamic> json) => _$TextStyleModelImpl(
      fontFamilyName_font: json['fontFamilyName_font'] as String?,
      fontFamilyStyle_enum_fontStyle: $enumDecodeNullable(_$FontStyleEnumMap, json['fontFamilyStyle_enum_fontStyle']) ?? FontStyle.normal,
...
Map<String, dynamic> _$$TextStyleModelImplToJson(_$TextStyleModelImpl instance) => <String, dynamic>{
      'fontFamilyName_font': instance.fontFamilyName_font,
      'fontFamilyStyle_enum_fontStyle': _$FontStyleEnumMap[instance.fontFamilyStyle_enum_fontStyle],
