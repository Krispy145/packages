...
abstract class _ThemeStateStore with LoadStateStore, Store {
  ...
  Future<void> _loadThemeModel() async {
    try {
      baseThemeModel =
          await repository?.fetchTheme(id: baseThemeConfiguration.id);
  ...
  ThemeData _buildTheme() {
    ...
    return ThemeData(
      ...
      cardTheme: componentThemesModel
          ?.getComponentThemeFromStyleType<CardThemeData?>(styleType),
      ...
      dialogTheme: componentThemesModel
          ?.getComponentThemeFromStyleType<DialogThemeData?>(styleType),
      ...
      tabBarTheme: componentThemesModel
          ?.getComponentThemeFromStyleType<TabBarThemeData?>(styleType),
    );
  }
