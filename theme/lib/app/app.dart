...
class AppTheme {
  ...
  static ColorSchemes colorStyles({String? styleTypeName}) =>
      baseThemeModel?.colors[styleTypeName ?? styleType] ??
      const ColorSchemes(dark: ColorModel(), light: ColorModel());

  /// [textStyleTypes] is a getter that returns the [TextTypes] instance.
  static TextTypes? textStyleTypes({String? styleTypeName}) =>
