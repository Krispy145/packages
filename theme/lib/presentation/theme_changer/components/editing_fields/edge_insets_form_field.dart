...
//           children: [
//             NumberEditingTextField(controller: _topController, enabled: topEnabled, onChanged: onTopChanged),
//           ],
//         ),
//         Row(
//           mainAxisAlignment: MainAxisAlignment.center,
//           children: [
//             NumberEditingTextField(controller: _leftController, enabled: leftEnabled, onChanged: onLeftChanged),
//             Padding(
//               padding: const EdgeInsets.all(8.0),
//               child: Container(color: Colors.red, padding: value, child: Container(width: 40, height: 40, color: Colors.grey)),
//             ),
//             NumberEditingTextField(controller: _rightController, enabled: rightEnabled, onChanged: onRightChanged),
//           ],
//         ),
//         Row(
//           mainAxisAlignment: MainAxisAlignment.center,
//           children: [
//             NumberEditingTextField(controller: _bottomController, enabled: bottomEnabled, onChanged: onBottomChanged),
//           ],
//         ),
//         Sizes.m.spacer(),
//         ElevatedButton(
