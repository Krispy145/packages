...
class SecureInstagramDataSource
    extends SecureDataSource<InstagramUserModel, Map<String, dynamic>> {
  ...
  @override
  Future<Pair<RequestResponse, InstagramUserModel?>> search(
  ...
  @override
  Future<Pair<RequestResponse, List<InstagramUserModel?>>> searchAll(
    Map<String, dynamic> query,
  ) async {
    AppLogger.print(
