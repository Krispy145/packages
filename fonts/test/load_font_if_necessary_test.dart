...
// import 'package:fonts/temp/src/asset_manifest.dart';
// import 'package:fonts/temp/src/google_fonts_base.dart';
// import 'package:fonts/temp/src/google_fonts_descriptor.dart';
// import 'package:fonts/temp/src/google_fonts_family_with_variant.dart';
...
// // const expectedCachedFile = 'Foo_regular_1194f6ffe4d2f05258573616a77932c38041f3102763096c19437c3db1818a04.ttf';
...
// // final _fakeResponseFile = DOFontsFile(
// //   _fakeResponseHash,
// //   // _fakeResponseLengthInBytes,
// // );
// // final _fakeResponseDifferentFile = DOFontsFile(
...
//     await Future.wait([loadFontIfNecessary(fakeDescriptor), loadFontIfNecessary(fakeDescriptor), loadFontIfNecessary(fakeDescriptor)]);
//     verify(mockHttpClient.gets(anything)).called(1);
//   });
...
//     expect(
//       () async => loadFontByteData('fontFamily', Future.delayed(const Duration(milliseconds: 100), () => null)),
//       returnsNormally,
//     );
//   });
// }
